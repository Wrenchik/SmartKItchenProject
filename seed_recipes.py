...
products = [
    ...
    ("помидоры","fast"), ("огурцы","fast"), ("майонез","fast"), ("чай", "long")
...
# ================= LUNCH — SOUPS =================
("Куриный суп", 2, "lunch", "кастрюля", [
    ("курица", 0.3),
    ("картофель", 0.3),
    ("морковь", 0.1),
    ("лук", 0.1)
]),
("Овощной суп", 2, "lunch", "кастрюля", [
    ("картофель", 0.3),
    ("морковь", 0.1),
    ("лук", 0.1)
]),
("Рисовый суп", 2, "lunch", "кастрюля", [
    ("рис", 0.15),
    ("морковь", 0.1),
    ("лук", 0.1)
]),
# ================= LUNCH — DRINKS =================
("Компот", 4, "lunch", "кастрюля", [
    ("сахар", 0.1)
]),
("Чай", 4, "lunch", "кастрюля", [
    ("чай", 1)
]),
